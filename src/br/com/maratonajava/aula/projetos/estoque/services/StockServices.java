package br.com.maratonajava.aula.projetos.estoque.services;

import br.com.maratonajava.aula.projetos.estoque.domain.*;
import br.com.maratonajava.aula.projetos.estoque.exceptions.InsuficientAmountException;
import br.com.maratonajava.aula.projetos.estoque.exceptions.ProductNotFoundException;
import br.com.maratonajava.aula.projetos.estoque.exceptions.StockNotFoundException;
...
public abstract class StockServices {
    ...
    private static int modifyProductQtd(int qtd, int stockIndex, String productName){//modify products Qtd and return the new amount
        ...
        if ((product.getQtd()) < (qtd) && (qtd < 0)){//if it's a substracting action and the amount is insuficient for the subtract, throw this exception
